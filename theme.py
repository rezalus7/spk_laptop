...
def inject():
    ...
    /* Ambient Blur Orbs di Latar Belakang agar Terasa Hidup */
    ...
    /* ── STREAMLIT CHROME & TOOLBAR CLEANUP ── */
    ...
    /* ── PERBAIKAN HEADER & TOMBOL SIDEBAR NATIVE ── */
    ...
    /* ── SLIDERS & TABS ── */
    [data-testid="stSlider"] [data-testid="stThumbValue"] { color: var(--accent2) !important; font-family: 'Space Mono', monospace; }
    ...
    /* ── FORMS & EXPANDER (GLASSMORPHISM EMBED) ── */
    ...
    /* ── CUSTOM SPK MATRIKS TABLE (PREMIUM) ── */
    .spk-table-wrap { 
        overflow-x: auto; 
        border-radius: 16px; 
